...
class DatePickerPage(BasePage):
    ...
    def set_date(self):
        ...
        value_day_before = input_date.get_attribute('value')
        input_date.click()
        self.set_date_by_text(self.locators.DATE_SELECT_MONTH, date.month)
        self.set_date_by_text(self.locators.DATE_SELECT_YEAR, date.year)
        self.set_date_item_from_list(self.locators.DATE_SELECT_DAY_LIST, date.day)
        value_date_after = input_date.get_attribute('value')
        return value_day_before, value_date_after
...
class SliderPage(BasePage):
    ...
    def change_slider_value(self):
        ...
        self.action_drag_and_drop_by_offset(slider_input, random.randint(-25, 75), 0)
...
class TabsPage(BasePage):
    ...
    def check_tabs(self, name_tab):
        ...
        button = self.element_is_clickable(tabs[name_tab]['title'])
        button.click()
...
class MenuPage(BasePage):
    ...
    def check_menu(self):
        menu_item_list = self.element_are_present(self.locators.MENU_ITEMS_LIST)
        data = []
