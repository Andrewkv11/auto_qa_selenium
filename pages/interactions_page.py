...
from locators.interaction_pages_locators import SortablePageLocators, SelectablePageLocators, ResizablePageLocators, \
...
class ResizablePage(BasePage):
    ...
    def change_size_resizable_box(self):
        ...
        time.sleep(3)
        self.action_drag_and_drop_by_offset(self.element_is_present(self.locators.RESIZABLE_BOX_HANDLE), 300, 150)
...
class DroppablePage(BasePage):
    ...
    def drop_simple(self):
        simple_tab = self.element_is_visible(self.locators.SIMPLE_TAB)
        simple_tab.click()
    ...
    def drop_accept(self):
        accept_tab = self.element_is_visible(self.locators.ACCEPT_TAB)
        accept_tab.click()
    ...
    def drop_prevent(self):
        prevent_tab = self.element_is_visible(self.locators.PREVENT_TAB)
        prevent_tab.click()
        drag_div = self.element_is_visible(self.locators.DRUG_ME_PREVENT)
    ...
    def drop_revert_draggable(self, type_drag):
        drags = {'will_revert': self.locators.WILL_REVERT, 'not_will_revert': self.locators.NOT_REVERT}
        revert_tab = self.element_is_visible(self.locators.REVERT_TAB)
        revert_tab.click()
...
class DraggablePage(BasePage):
    ...
    def get_before_and_after_positions(self, drag_element):
        self.action_drag_and_drop_by_offset(drag_element, random.randint(10, 50), random.randint(10, 50))
    ...
    def axis_restricted_x(self):
        axis_tab = self.element_is_visible(self.locators.AXIS_TAB)
        axis_tab.click()
